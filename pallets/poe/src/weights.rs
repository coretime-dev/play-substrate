...
//! DATE: 2022-11-02, STEPS: `20`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_claim(d: u32, ) -> Weight {
		Weight::from_ref_time(15_000_000 as u64)
			// Standard Error: 168
			.saturating_add(Weight::from_ref_time(6_469 as u64).saturating_mul(d as u64))
	...
	fn revoke_claim(d: u32, ) -> Weight {
		Weight::from_ref_time(15_000_000 as u64)
			// Standard Error: 203
			.saturating_add(Weight::from_ref_time(14_441 as u64).saturating_mul(d as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: PoeModule Proofs (r:1 w:1)
	...
	fn transfer_claim(d: u32, ) -> Weight {
		Weight::from_ref_time(11_000_000 as u64)
			// Standard Error: 139
			.saturating_add(Weight::from_ref_time(11_123 as u64).saturating_mul(d as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
